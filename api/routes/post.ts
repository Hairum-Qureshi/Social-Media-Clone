...
import { createPost, deletePost, handleLikes, postComment, getAllPosts, getAllLikedPosts, getFollowingUsersPosts, getUserPosts, deleteComment, getAllYourPosts } from "../controllers/post";
...
router.get("/current-user/all", checkAuthStatus, getAllYourPosts);
