				...
				<>
					<div>
						{extendedBio?.workExperience &&
							...
							extendedBio.workExperience.map((workExperience: IWorkHistory) => {
								return (
									<div className="bg-neutral-900 border border-slate-700 rounded-md p-3 mt-3 flex">
										<div className="w-full">
											<p className="font-semibold">{workExperience.jobTitle}</p>
										...
										{location.pathname.includes("settings") &&
											extendedBio?.userData.username === userData?.username && (
